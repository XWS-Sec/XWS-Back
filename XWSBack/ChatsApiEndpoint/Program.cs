        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            Host.CreateDefaultBuilder(args)
                .ConfigureWebHostDefaults(webBuilder =>
                {
                    ...
                    {
                        options.Listen(IPAddress.Loopback, 44324, listenOptions =>
                        {
                ...
                {
                    var endpointConfig = new EndpointConfiguration(EndpointInstances.ChatsApiEndpoint);
                    var routing = endpointConfig.Configure(EndpointInstances.ChatsApiEndpoint);
